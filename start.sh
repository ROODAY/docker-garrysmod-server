...
docker run -it -d --name gmod --restart always \
	...
	-v $PWD/garrysmod/cfg:/gmodserv/garrysmod/cfg/ \
	-v $PWD/garrysmod/addons:/gmodserv/garrysmod/addons/ \
	gmod-server -port 27015 -tickrate 60 -maxplayers 24 \
	+gamemode terrortown +map ttt_67thway_v6 \
	+host_workshop_collection 1413001823 \
	+sv_setsteamaccount 3B6C6D56043FD72170A69830108C092D
